...
| Mission window may contain “more than one mission on a given system” | **Present.** Each unfinished player mission is an icon (its 73x48 picture, its name over it) in the left column; clicking one shows its target and team on the right, the picked one in the side's frame. Missions 50 pixels apart, members 43 (measured on TeeJ's screenshots, 2026-09-24). |
