...
| Not in the repo | `.DAT` files are not here at all; `data/*.json` was copied here (§6 step 0) and **removed 2026-09-22** once every reader was on the pack - the source repo keeps it. `manual/pages/` remains only in the source repo. |
