...
| **Backdrop** | `world.png` at 900×900, and `map.json` coordinates are its pixels (SCHEMA.md §4). Since 2026-09-22 the map view draws the pack's `map_image` behind the regions, scaled together; before that the Star Wars picture was baked into `Main.tscn` and this file was never shown. |
