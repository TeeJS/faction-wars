...
| **Backdrop** | `world_1941.jpg`, a public-domain 1941 atlas page (publicdomainpictures.net image 510694) cropped to its neat line, 1750×1050. `map_image_rect` `[0,0,700,420]`: the map space is the picture at 1/2.5, a ~700-unit span like Star Wars's, because coordinates are travel time (`Planet.DistanceTo`). The right ~12% of the frame sits under the message panel, which hides the Central Pacific regions. |
...
| **Characters** | 71 (+27): Model, Rundstedt, Student, Galland, Ozawa, Marshall, King, Harris, Tedder, Rokossovsky, Chuikov, Spruance, Wingate, Chennault, Zhu De, Menzies… **Opening places** (2026-09-22, `starts_at`): the leaders open in their own countries — Churchill, Alanbrooke, Montgomery, Cunningham and Dowding in Britain; Roosevelt, Eisenhower, Marshall and Nimitz in the United States; de Gaulle and Leclerc in France; Stalin and Zhukov in Russia; Chiang in China; Hitler, Göring, Guderian and Dönitz in Germany; Mussolini, Ciano and Graziani in Italy; Tojo, Yamamoto and Nagumo in Japan. |
